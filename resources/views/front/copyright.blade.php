            ...
            <div class="block">
                <div class="container">
                    <div class="title center">
                        <h1 class="size-lg">Copyright Statement</h1>
                    </div>
                    @foreach ($Copyright as $item)
                    <h2 class="no-line custom-color size-lg">Copyright Statement</h2>
                    <div class="panel-group faq" id="Terms">
                        ...
                        <div class="panel">
                            ...
                            <div id="Terms{{$item->id}}" class="panel-collapse collapsed">
