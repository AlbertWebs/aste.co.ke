...
<head>
    ...
    <title>Leather Bags in Kenya | Aste Company Limited | Canvas Products in Kenya</title>
    <meta name="keywords" content="Canvas Leather, Bags">
    <meta name="description" content="Canvas meets Leather">
...
<body>
                        ...
                        <div class="header-search header-search-extended header-search-visible d-none d-lg-block">
                            ...
                            <form action="{{url('/search-results')}}" method="get">
                                ...
                                <div class="header-search-wrapper search-wrapper-wide">
                                    ...
                                    <input type="search" class="form-control" name="query" id="q" placeholder="Search product or category..." required>
    ...
    <div class="mobile-menu-container">
        <div class="mobile-menu-wrapper">
            ...
            <form action="{{url('/search-results')}}" method="get" class="mobile-search">
                        ...
                        <div class="form-tab">
                            ...
                            <div class="tab-content" id="tab-content-5">
                                ...
                                <div class="tab-pane fade" id="register" role="tabpanel" aria-labelledby="register-tab">
                                    <form action="{{url('/')}}/secure-sign-up" method="POST" id="secure-sign-up">
                                        @csrf
                                        <div class="form-group">
                                            <label for="register-email">Full Name *</label>
                                            <input type="text" class="form-control" id="register-email" name="register-name" required>
                                        </div><!-- End .form-group -->
                                        ...
                                        <div class="form-group">
                                            <label for="register-password">Password *</label>
                                            <input type="password" class="form-control" id="register-password" name="register-password-confirm" required>
                                        </div><!-- End .form-group -->
